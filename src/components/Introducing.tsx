...
const Introducing = () => {
  return (
    <div className='mt-5 w-full relative flex flex-col md:flex-row justify-between h-[100vh]'>
      ...
      <div 
        className='absolute w-[250px] h-[380px] md:h-[500px] md:w-[380px] lg:w-[400px] lg:h-[600px] left-5 sm:left-20 top-40 bg-gray-400 opacity-85 rounded-xl'
      >
        <img 
          src="/man1.jpg" 
          alt="man office" 
        ...
        <div className='absolute flex justify-center flex-col h-[50%]  items-center bottom-0 text-center'>
